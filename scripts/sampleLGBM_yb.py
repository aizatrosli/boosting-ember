...
with mlflow.start_run(run_name="demo_ember_lightgbm_lc_cpuboost") as run:
    ...
    '''
    mlflow.log_dict({
        'test_scores': cv_ember.test_scores_,
        'test_scores_mean': cv_ember.test_scores_mean_,
        'test_scores_std': cv_ember.test_scores_std_,
        'train_scores': cv_ember.train_scores_,
        'train_scores_mean': cv_ember.train_scores_mean_,
        'train_scores_std': cv_ember.train_scores_std_,
        'train_sizes': cv_ember.train_sizes_,
        }, 'learning_curve.json')
    '''
